...
<html>
    ...
    <body>
        <form class='form-wrapper cf' action='mangament.php' method='POST'>
            <input type='text' placeholder='Search here...' name='search'>
                <button type='submit'>Search</button>
            </form>";
     
       echo "<div style='width:150px;height:150px;position:fixed;right:500px;line-height:3em;overflow:scroll;padding:150px;'>
                ";
                echo "<form action='mangament.php' method='POST'>
                <table border='1'>
<tr>
<th>Activity_ID</th>
<th>Content</th>
...
echo '<td><button type="submit" name="deleteItem" value="'.$row['Activity_ID'].'" > Delete </button> </td>"';
  echo "</tr>";
  }
echo "</table>";
    echo"</form>";
