...
window.onload = function() {
  ajaxpage('profile_update_page.php', 'rightcolumn');
};
...
<div id="leftcolumn">
<a href="javascript:ajaxpage('profile_update_page.php', 'rightcolumn');">Basic Information</a>
<a href="javascript:ajaxpage('profile_update_page1.php', 'rightcolumn');">Security Setting</a>
<a href="javascript:ajaxpage('profile_update_page2.php', 'rightcolumn');">Additional Information</a>
